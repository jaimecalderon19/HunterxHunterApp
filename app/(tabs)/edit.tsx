  ...
  useEffect(() => {
    if (cazador) {
      setFormData({
        ...
        edad: cazador.edad.toString(),
        altura: cazador.altura.toString(),
        peso: cazador.peso.toString(),
        genero: cazador.genero,
        tipoLicencia: cazador.tipoLicencia,
    ...
    return (
      <LinearGradient colors={['#0f172a', '#1e293b']} style={styles.gradient}>
        <View style={styles.emptyContainer}>
          <Ionicons name="create-outline" size={64} color="#94a3b8" />
          <Text style={styles.emptyText}>No hay cazador seleccionado</Text>
          <Text style={styles.emptySubtext}>Selecciona un cazador de la lista para editarlo</Text>
        </View>
      </LinearGradient>
    );
  }
      ...
      >
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.header}>
            <Ionicons name="create" size={48} color="#facc15" />
            <Text style={styles.title}>✏️ Editar Cazador</Text>
            <Text style={styles.subtitle}>Modifica la información de {cazador.nombre}</Text>
          </View>
          ...
          <View style={styles.buttonContainer}>
            ...
            <TouchableOpacity 
              ...
              onPress={actualizarCazador}
              disabled={loading}
            >
              <Ionicons name="save" size={16} color="#0f172a" style={{ marginRight: 8 }} />
